...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // TODO: wire up actual sign-in call
  ...
  return (
    <main className="min-vh-100 d-flex">
      ...
      <div
        ...
        style={{
          width: "45%",
          background: `linear-gradient(160deg, ${BRAND} 0%, #c93d7f 100%)`,
        }}
      >
        <div>
          <Link
        ...
        <div>
          <h2 className="fw-bold mb-3" style={{ fontSize: "2.25rem", lineHeight: 1.2 }}>
            Dialysis care,
            <br />
            simplified.
          </h2>
          <p className="mb-5" style={{ color: "rgba(255,255,255,0.85)", maxWidth: "380px" }}>
          ...
          <div className="d-flex flex-column gap-4">
            <div className="d-flex align-items-start gap-3">
              ...
              <div>
                <div className="fw-semibold">Instant scheduling</div>
                <div className="small" style={{ color: "rgba(255,255,255,0.75)" }}>
                  Book or reschedule sessions in seconds.
                </div>
              </div>
            </div>
            ...
            <div className="d-flex align-items-start gap-3">
              ...
              <div>
                <div className="fw-semibold">Track your progress</div>
                <div className="small" style={{ color: "rgba(255,255,255,0.75)" }}>
                  View treatment history and vitals over time.
                </div>
              </div>
            </div>
      ...
      >
        <div className="w-100" style={{ maxWidth: "420px" }}>
          ...
          >
            <h1 className="fs-4 fw-bold mb-1">Sign in</h1>
